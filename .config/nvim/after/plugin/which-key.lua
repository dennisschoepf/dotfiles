...
which_key.register({
  ...
  o = {
    name = "+organize (neorg)",
    i = { "<cmd>e ~/notes/inbox.norg", "Open Personal Inbox" },
    p = { "<cmd>e ~/notes/projects", "Open Personal Projects" },
    s = { "<cmd>e ~/notes/someday.norg", "Open Personal Someday List" },
    j = {
      name = "+journal",
      ...
      v = { "<cmd>85vsplit | Neorg journal today<cr>", "Open today's note to the side" },
    },
  },
